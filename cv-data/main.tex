...
\hypersetup{
    ...
    pdfauthor={Phu Nguyen}, % Author of the PDF
...
\mytitle{Phu Nguyen}{phu.nguyen@hwr-berlin.de}{www.linkedin.com/in/phu-nguyen-scom}{Berlin School of Economics and Law, Berlin, Germany} % Insert your custom title
%\mytitle{Phu Nguyen}{phu.nguyen@hwr-berlin.de}{yourwebsite.com}{Your Address\\Goes here\\This field can be excluded} % Insert your custom title
...
\pdfbookmark[1]{Research Interest}{interest}
...
\pdfbookmark[1]{Professional Experience}{exp_professional}
\section*{Professional Experience}
\label{exp_professional}
\input{exp_professional.tex}
...
\vspace{-.75em}
\small
\faGoogle~\href{https://scholar.google.com/citations?user=_Lzzc3sAAAAJ&hl=en}{Google Scholar}\\
...
\pdfbookmark[2]{Presentations}{Presentations}
...
\printbibliography[type=inbook,heading=none,resetnumbers=false,keyword=B]
